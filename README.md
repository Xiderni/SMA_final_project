...
One of the central steps in our analysis was the manual classification of the 500 most frequently used nouns and adjectives for each political orientation into “issue-based” (IB) and “horse race” (HR) categories. This helped us develop a measurable approach to identifying framing patterns, but it also simplified the complex ways language works in real-world contexts. Language is context-dependent. For instance, the word “politique” might describe policy in a neutral way in one article but point to strategic manoeuvring in another. 

Our method of scoring articles based on how often IB and HR words appeared also has its limits. While we tried to adjust for article length and account for the different number of terms in each category, the approach doesn’t reflect how information is emphasized within an article. For example, a key framing term may only appear once but be placed in a headline or final paragraph, giving it more weight than its frequency suggests. This means our model may not always capture the full rhetorical effect of a term within the article’s overall structure.

All of the articles were processed in French using spaCy’s fr_core_news_sm language model. This ensured we used tools appropriate for the language, but it didn’t eliminate challenges. Journalistic language can be complex and nuanced, and automated tools sometimes struggle with accuracy, especially when sentences are long or contain sarcasm or irony. Also, since we reported our findings in English, we had to translate terms and summaries carefully. Although we made every effort to retain original meanings, some cultural or idiomatic expressions might have lost nuance during this process.

A structural limitation in our dataset also needs to be addressed. The right-leaning portion of our sample includes mostly weekly publications, whereas the left and centre have a more balanced mix of daily and weekly newspapers. Weekly papers tend to publish more analytical and in-depth articles, which are more likely to focus on issues rather than electoral strategy. This creates a built-in bias that may have inflated the number of issue-based articles attributed to right-wing media. In an ideal setup, we would have balanced daily and weekly publication types across all political orientations. However, due to the limitations of the Factiva database, which contains far more right-wing weeklies than right-wing dailies,  achieving that balance wasn’t possible. Enforcing equal representation across publication types would have forced us to dramatically reduce the overall sample size, weakening the reliability of the findings.

# V) Conclusion
This study's analysis of French media coverage during the 2024 snap elections reveals a predominant use of strategic game framing across political spectrums, with left-leaning outlets employing it most frequently, followed by centrist and right-leaning media. The findings demonstrate that daily newspapers relied more heavily on horse-race journalism compared to weeklies, which included more substantive policy discussions. Topic modeling confirmed these patterns, showing a media landscape that prioritizes electoral competition over policy debates, potentially contributing to cynicism and political polarization. The results suggest that the French media environment, particularly in its daily news cycle, mirrors concerning political events where strategic coverage overshadows issue-based reporting. While the research highlights structural limitations in media sampling and classification methods, it underscores the crucial role of journalistic framing in shaping democratic discourse. These findings give insights to broader discussions about media responsibility in democratic processes, emphasizing the need for balanced reporting that combines electoral dynamics with meaningful policy analysis to foster an informed electorate and mitigate polarization. Future research could be conducted through comparative cross-national studies and more sophisticated textual analysis techniques.
